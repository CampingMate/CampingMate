...
class MapViewModel : ViewModel(){
    ...
    fun getBookmarkedCamp(userId:String,campData : MutableList<LocationBasedListItem> ){
        viewModelScope.launch {
            ...
            docRef.get().addOnSuccessListener {
                ...
                _campMarker.value?.removeAll(bookmarkMarker)
                ...
                _campMarker.value?.addAll(bookmarkMarker)
    ...
    fun getBookmarkedList(campData: MutableList<LocationBasedListItem>) {
        //로그인 여부 확인
